  ...
  return (
    <div>
      ...
      <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-8 w-full max-w-md mt-10">
        <p className="text-xl font-bold mb-5 ">Edit course</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              name="Name"
              placeholder="Enter course name to edit"
          ...
          <div>
            ...
            <input
              type="text"
              name="Description"
              placeholder="Enter course description to edit"
          ...
          <div>
            ...
            <input
              type="text"
              name="VideoUrl"
              placeholder="Enter video url to edit"
